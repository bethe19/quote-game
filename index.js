document.addEventListener("DOMContentLoaded", () => {
    ...
    if (path === "/" || path.endsWith("index.html")) {
        const errorMassages = [
            "enter your name you fucking bastard",
            "just enter your name, don't make me do this you shit!",
            "bastard of no-name enter your name!"
        ];
        let i = 0;
